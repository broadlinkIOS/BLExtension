...
+ (NSCalendar *)gregorianCalendarInstance
{
...
- (NSDateComponents *) gregorianComponents {
  NSCalendar *calendar = [NSDate gregorianCalendarInstance];
  NSDateComponents *comps = [calendar components:DATE_COMPONENTS fromDate:self];
  return comps;
}

- (NSDateComponents *) currentComponents {
  NSCalendar *calendar = [NSDate calendarInstance];
  NSDateComponents *comps = [calendar components:DATE_COMPONENTS fromDate:self];
  return comps;
}
